...
<div id="content">
<form action="Adminfeedback.jsp?pageno=1" align="center" method="post">
<input type="submit" value="View Feedback" class="sub" >
</form><br /><br /><br />
<form action="Adminquestion.jsp?pageno=1" align="center" method="post">
<input type="submit" value="View Question" class="sub">
</form><br /><br /><br />
<form action="Adminaddquestion.jsp?pageno=1" align="center" method="post">
<input type="submit" value="Add Questions"class="sub" >
</form><br /><br /><br />
</div>
</div>
