...
body {
	...
	/* [disabled]color: #333; */
	width: 100%;
	background-image: url(bkg_resources.png);
}
body,td,th {
	color: #000;
	left: 70%;
...
#content {
	...
	left: 30%;
	right: auto;
	background-image: url(blue-gradient-background.jpg);
	color: #FFF;
	padding-top: 1%;
}
...
%>
			<form name="loginform" id="loginform" action="feed.jsp">
    <p>
      <label>User Name</label>
    </p>
    <p>
      <input type="text" name="user" placeholder="Enter UserName" maxlength="10" required>
  </p>
    <p>
      <label>E-Mail</label>
      </p>
    ...
    <p>
      ...
      <textarea name="textarea" id="textarea" cols="50" rows="10"  placeholder="Enter Feedback" required></textarea>
  </p>
    <p>
      <input type="submit" value="   Send   " onsubmit="validateForm();"  />
    </p>
  </form>
  </div>
</div>
