...
<title>ALRMIQ | Add Question</title>
<style type="text/css">
a {
	color: #0FF;
	font-weight: bold;
...
<body background="blue-gradient-background.jpg">
<!-- Header start-->
...
<div class="cnt_hd" align="center">
    <div align="center">Add Question</div>
</div>
  
  <div id="content" >
  <%
String login_msg=(String)request.getAttribute("success1");  
if(login_msg!=null)
...
<form action="addquestion.jsp" method="post">
  <p>Question I.D<b>&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> 	
    <input type="text" class="text" name="qid"  placeholder="Enter Q_I.D" required>
   &nbsp;&nbsp;&nbsp;
  Q_Category<b>&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> 
    <select name="option1" class="text">
    <option>Aptitude</option>
    <option>Logical Reasoning</option>
    <option>Maths I.Q</option></select>
  </p>  <br />
  <p>Question<b>&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;:&nbsp;&nbsp; &nbsp;&nbsp; </b> 
    <input type="textaree" name="question" class="text1" placeholder="Enter New Question" required>
  </p>  <br />
  <p>Option A<b>&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> 
    <input type="text" name="a" class="text" placeholder="Enter Option A" required>
  &nbsp;&nbsp;&nbsp;&nbsp;
Option B<b>&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> 
    <input type="text" name="b" class="text" placeholder="Enter Option B" required>
  </p>  <br />
<p>Option C<b>&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> 
    <input type="text" name="c" class="text" placeholder="Enter Option C" required>
  &nbsp;&nbsp;&nbsp;
  Option D<b>&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> 
    <input type="text" name="d" class="text" placeholder="Enter Option D" required>
  </p> <br />
<p >Correct Option<b>&nbsp;&nbsp;*:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> 
    <input type="text" name="correct" class="text" placeholder="Enter Correct Option" required>
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="submit" class="text" name="button"  value="   Add Question   >>>" />
 </p>
</form>
<p>&nbsp;</p>
  </div>
