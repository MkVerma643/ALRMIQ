...
<div id="navigation">
    <ul>
      ...
      <li class="link-active"><a href="Exam.jsp" title="ALRMIQ | Exam">EXAM</a> | </li>
...
<div id="Intro" class="cnt_txt" align="center">
  <div class="cnt_hd" align="center">Test Page</div>
...
<font color="gray" size="5"> 
 <b>Start Time : </b><%= new java.util.Date() %>,
 ...
 <%  
   ...
   %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Time Left :</b>&emsp;&emsp;sec 
<marquee><pre>Best Of Luck For Exam...!!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You will get 30 sec for each question, 20 question in 10 minutes. So Speed Up . . . ! ! !&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;All The Best...!!!</pre></marquee>
   <hr /><br />
</font>
 <div id="apDiv2">
 <script type="text/javascript">window.onload = CreateTimer("apDiv2", 600);</script>
 </div>
...
{	
	...
	PreparedStatement ps1=con.prepareStatement("select count(*) from question where qcategory=?");
	ps1.setString(1,qcategory);
	ResultSet rs1= ps1.executeQuery();
	rs1.next();
	count=rs1.getInt(1);
	PreparedStatement ps=con.prepareStatement("select * from question where qcategory=? ORDER BY RAND() LIMIT 0,20;");
	...
	while(rs.next())
	{
		%>
		<tr>
        <td colspan="4"><font face="Palatino Linotype, Book Antiqua, Palatino, serif" size="+2" color="black"><%=option%>). <%=rs.getString(3)%></font></td></tr>
        <tr><td></td></tr><tr><td></td><tr><td></td></tr>
        <tr>
		<td>A.<input type="radio" value="A" name="<%=rs.getString(1)%>" /><font face="Palatino Linotype, Book Antiqua, Palatino, serif" size="+1" color="blue"><%=rs.getString(4)%></td>
        <td>B.<input type="radio" value="B" name="<%=rs.getString(1)%>" /><font face="Palatino Linotype, Book Antiqua, Palatino, serif" size="+1" color="blue"><%=rs.getString(5)%></td>
        <td>C.<input type="radio" value="C" name="<%=rs.getString(1)%>" /><font face="Palatino Linotype, Book Antiqua, Palatino, serif" size="+1" color="blue"><%=rs.getString(6)%></td>
        <td>D.<input type="radio" value="D" name="<%=rs.getString(1)%>" /><font face="Palatino Linotype, Book Antiqua, Palatino, serif" size="+1" color="blue"><%=rs.getString(7)%></td>
        </tr>
        <tr><td></td></tr><tr><td></td><tr><td></td></tr><tr><td></td></tr><tr></td><td></td></tr>
	<%
	option ++;
	}
}
