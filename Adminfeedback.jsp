...
<tr align="center">
	<td align="center"><font size =4 color='black'>Id</font></td>
	<td align="center"><font size =4 color='black'>Date</font></td>
	<td align="center" width=10%><font size =4 color='black'>Name</font></td>
	<td align="center"><font size =4 color='black'>Email</font></td>
	<td align="center"><font size =4 color='black'>Message</font></td>
...
try
{
	...
	PreparedStatement ps1=con.prepareStatement("select count(*) from feedback");
...
%>
	<tr><td align="right" colspan="6"><input type="hidden" name="pno" value=<%=pageno%>><center><input type="submit" value="Delete"></td></tr>
    <tr><td colspan="9">
<center>
<%
int no_of_pages=0;
...
{
%>
<a href=<%="Adminfeedback.jsp?pageno="+i%> style="text-decoration: none; color:#2A3F55" ><%=i%></a>
