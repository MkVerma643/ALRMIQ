...
<div id="content"> 
<%
String login_msg1=(String)request.getAttribute("success1");  
if(login_msg1!=null)
out.println("<font color=white size=2px>"+login_msg1+"</font>");
%>
 		<%
...
%>
     <form name="loginform" id="loginform" method="post" action="log.jsp">
     <%
        String referer = request.getHeader("Referer");
		if(referer.length() == 37)
		{
			%><p class="para">Please Login to Continue...</p><%
		}
       	%>
    <p>
    ...
    <p>
      <input type="text" name="uname" id="uname" placeholder="Enter UserName" maxlength="10" required>
      </p>
    <p><br />
  ...
  <br />
    <p>&nbsp; New To ALRMIQ,&nbsp;<a href="Register.jsp"title="ALRMIQ | Register">Register</a></p>
  </div>
</div>
