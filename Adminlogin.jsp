...
<div id="Intro" class="cnt_txt" align="center">
  <div class="cnt_hd" align="center">
    <div align="center">Admin Login Page</div>
</div>
  
  <div id="content">
   <form name="loginform" id="loginform" method="post" action="adminlog.jsp">
    <p>
      <label>Admin</label>
    </p>
    <p>
      <input type="text" name="uname" placeholder="Admin Name" maxlength="10" required>
      </p>
    <p><br />
